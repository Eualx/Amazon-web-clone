...
{navStateData.state.msg}
        ...
        <form action="">
          ...
          > {
            loading.signIn ? (<ClipLoader color="#36d7b7" size={15}></ClipLoader>):
            ("Sign In")
          }
          </button>
        </form>
        ...
        >
          {
            loading.signUp ? (<ClipLoader color="#36d7b7" size={15}/>):
